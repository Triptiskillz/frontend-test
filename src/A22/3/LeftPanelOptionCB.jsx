...
const updateCBs=(inpValue,checked,value)=>{
    ...
    return (
        <div className="row border bg-light">
            ...
            <div className="col-12">{makeCheckboxes(allOptions.dept, dept.split(','), "dept", "Select dept")}</div>
            <div className="col-12">{makeCheckboxes(allOptions.designation, designation.split(','), "designation", "Select designation")}</div>
