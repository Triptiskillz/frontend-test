...
function LeftPanelOptions({ options, bestsellers,languages, OnOptionChange }) {
    console.log(options)
    ...
    return (
        <div className="row border bg-light">
            ...
            <div className="col-12">{makeCheckboxes(languages, language.split(","), "language", "Language")}</div>
        </div>
    )
