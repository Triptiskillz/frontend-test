            ...
            {person.map((pr) => (
              <div class=" col mb-4 text-center">
                <div class="card-body p-2 bg-warning">
                  ...
                  <Link className='text-dark text-decoration-none p-4' to={`/car/${pr.Carid}/edit`}><i class="fa fa-edit"></i></Link>
                  
                  <Link className='text-dark text-decoration-none p-4' to={`/car/${pr.Carid}/delete`}><i class="fa fa-trash"></i></Link>
                </div>
              </div>
            ))}
          </div>
