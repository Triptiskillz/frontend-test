...
function LeftPanelOptions({ options, cities,companies,ages, OnOptionChange }) {
    console.log(options)
    ...
    return (
        <div className="row border bg-light">
            ...
            <div className="col-12">{makeCheckboxes(cities, city.split(","), "city", "Select City")}</div>
            <div className="col-12">{makeCheckboxes(companies, company.split(","), "company", "Select Company")}</div>
            <div className="col-12">{makeDropdown(ages, minAge, "minAge", "Select minimum Age")}</div>
